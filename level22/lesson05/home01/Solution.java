...
public class Solution {
    ...
    public String getPartOfString(String string, String threadName) {
        ...
        try
        {
            ...
            result = string.substring(firstIndex, lastIndex).trim();

        }
        catch (Exception e)
        {
            if (FIRST_THREAD_NAME.equals(threadName)) throw new TooShortStringFirstThreadException();
            else if (SECOND_THREAD_NAME.equals(threadName)) throw new TooShortStringSecondThreadException();
